...
VALUES	(4, 2, 73.00, 'Havana white Rum, mint, lime shaken over ice'),
		(1, 2, 5500.00, 'Bottle'),
		(4, 3, 68.00, 'Bacardi Carta Blanca I Lime I Mint I Soda'),
		(10, 3, 35.00, ''),
		(3, 3, 30.00, ''),
		(3, 11, 44.00, 'ALSO AVAILABLE ON TAP'),
		(4, 11, 80.00, 'Havana Club Blanco, house-made sweet & sour mix, fresh mint, lime, soda.'),
		(5, 16, 27.00, ''),
		(9, 16, 32, ''),
		(6, 18, 18, '')
GO