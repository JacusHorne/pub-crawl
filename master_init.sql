...
VALUES  ('Rando Calrissian', 'rando@calrissian.co.za'),
...
CREATE TABLE [dbo].[Route_Rating] (
	...
	[rating] int NOT NULL,
	[comment] varchar(255),
	CONSTRAINT pk_route_rating PRIMARY KEY ([user_id], [route_id])
);
...
INSERT INTO [dbo].[Venue] ([name], [logo], [entrance_fee], [location], [phone_number])
VALUES	('Milk and Honey Bar', 'https://milkhoneybar.co.za/wp-content/uploads/2018/07/mh_logo_400w.png', 0, geography::Point(-26.023714216056987, 28.01435819441324, 4326), '0114652394'),
...
CREATE TABLE [dbo].[Route_Stop] (
    ...
    CONSTRAINT [pk_route_stop] PRIMARY KEY ([stop_number], [route_id])
...
CREATE TABLE [dbo].[Venue_Drink](
    ...
    CONSTRAINT [pk_venue_drink] PRIMARY KEY ([drink_id], [venue_id]),
...
GO
INSERT INTO [dbo].[Venue_Drink] ([drink_id], [venue_id], [price], [description])
VALUES
	(1, 1, R50, 'Good drink'),
	(1, 2, R75, 'Best drink'),
	(2, 1, R52, 'Good drink'),
	(3, 1, R650, 'The very best drink on the planet');
GO
...
CREATE TABLE [dbo].[Venue_Tag] (
	[tag_id] int NOT NULL,
	[venue_id] int NOT NULL,
	CONSTRAINT [pk_venue_tag] PRIMARY KEY ([tag_id], [venue_id])
);
